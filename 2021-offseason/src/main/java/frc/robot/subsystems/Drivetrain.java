...
public class Drivetrain extends SubsystemBase {
  ...
  public void curveDrive(double linearVelocity, double angularVelocity, boolean isQuickturn) {
    ...
    frontLeft.set(linearVelocity);
    SmartDashboard.putNumber("input into curve drive", linearVelocity);
  }

  @Override
  public void periodic() {
    // This method will be called once per scheduler run
    SmartDashboard.putNumber("front left applied ouptut", frontLeft.getAppliedOutput());
    SmartDashboard.putNumber("front left output current", frontLeft.getOutputCurrent());
    // SmartDashboard.putNumber("back left applied ouptut", backLeft.getAppliedOutput());
    // SmartDashboard.putNumber("back left output current", backLeft.getOutputCurrent());
