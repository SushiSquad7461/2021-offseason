...
public class ShiftButton extends Trigger {
   ...
   */
  public ShiftButton(BooleanSupplier isPressed) {
    super(isPressed);
  }
   ...
   */
  public ShiftButton whenPressed(final Command command, boolean interruptible) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenPressed(final Command command) {
    whenActive(command);
    return this;
  }
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenPressed(final Runnable toRun, Subsystem... requirements) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whileHeld(final Command command, boolean interruptible) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whileHeld(final Command command) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whileHeld(final Runnable toRun, Subsystem... requirements) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenHeld(final Command command, boolean interruptible) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenHeld(final Command command) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenReleased(final Command command, boolean interruptible) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenReleased(final Command command) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton whenReleased(final Runnable toRun, Subsystem... requirements) {
   ...
   * @param interruptible whether the command is interruptible
   */
  public ShiftButton toggleWhenPressed(final Command command, boolean interruptible) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton toggleWhenPressed(final Command command) {
   ...
   * @return this button, so calls can be chained
   */
  public ShiftButton cancelWhenPressed(final Command command) {
